 ...
 */
 /*
 function swhite_preprocess_html(&$variables) {
...
function swhite_preprocess_page(&$variables) {

  if($variables['page']['sidebar_first'] && $variables['page']['sidebar_second']){
	$variables['contentclass'] = 'col-sm-12 col-md-6 col-md-push-3';
	$variables['firstsidebarpush'] = 'col-md-pull-6';
	}
  elseif($variables['page']['sidebar_first'] || $variables['page']['sidebar_second']){
	if($variables['page']['sidebar_first']){
		$variables['contentclass'] = 'col-sm-12 col-md-9 col-md-push-3';
		$variables['firstsidebarpush'] = 'col-md-pull-9';
		}
	if($variables['page']['sidebar_second']){
		$variables['contentclass'] = 'col-sm-12 col-md-9';
		}
	}
  else{
	$variables['contentclass'] = 'col-md-12';
	}
}
/*
 ...
 */
/*
 * Without any preprocess hook to add js
 */
 /*
